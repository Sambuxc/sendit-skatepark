<template>
	<main class="w-svw h-svh">
		<header class="relative w-svw h-svh flex flex-col items-center">
			<nav class="fixed left-0 top-0 p-4 flex justify-between gap-5 text-center w-full">
				<div class="h-20 w-20 md:h-20 md:w-20">
					<LogoHeader />
				</div>


				<div class="flex md:gap-5 items-center lg:items-start justify-center">
					<div class="flex flex-col md:flex-row items-center gap-2 md:gap-5">
						<NuxtLink to="#bookings" class="bg-blue hover:bg-blue-light text-black">
							Book Us
						</NuxtLink>

						<NuxtLink to="#events" class="bg-green hover:bg-green-light text-black">
							Events
						</NuxtLink>
					</div>

					<div class="flex flex-col md:flex-row items-center gap-2 md:gap-5">
						<NuxtLink to="#gallery" class="bg-red hover:bg-red-light text-black">
							Ramps
						</NuxtLink>

						<NuxtLink to="#contact" class="bg-yellow hover:bg-yellow-light text-black">
							Contact
						</NuxtLink>
					</div>
				</div>
		...
		<section class="w-full h-fit flex flex-col md:flex-row items-center justify-center bg-yellow-50">
			...
			<div class="md:flex-1 flex flex-col items-center justify-center order-first md:order-last">
				<article class="my-2 p-5 w-full">
					...
					<p class="text-center">
						...
						<br />birthdays and private parties.
					</p>
				</article>
			</div>
		</section>
		...
		<section class="w-full h-fit flex flex-col md:flex-row items-center justify-center bg-yellow-50">
			<div class="md:flex-1 flex flex-col items-center justify-center order-last md:order-first">
					...
					<blockquote class="instagram-media" data-instgrm-captioned
						...
						<div style="padding:16px;"> <a
							...
							<p
								...
								<a href="https://www.instagram.com/p/DAO4BkgtAa1/?utm_source=ig_embed&amp;utm_campaign=loading"
									style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
									target="_blank">A post shared by Fii 🤓 | Photographer 📷 (@fionafinchett)</a>
							</p>
						</div>
					</blockquote>

					<h3 class="mt-6">Grit Studios</h3>
					<p class="text-center">A creative hub for young people in Stockport.</p>
					<a href="https://www.peoplewithgrit.org/" target="_blank" class="text-blue-500 hover:underline">Visit
						Website</a>
				</article>

				<article class="w-full md:w-1/3 flex flex-col items-center bg-white p-5 rounded-lg shadow-lg">
					<img src="../assets/images/grit_studios-and-stockport.jpg" alt="R-Time" class="mb-6 box-shadow rounded-md" />
					<h3>R-Time</h3>
					<p class="text-center">A charity that empowers young voices in Stockport.</p>
					<a href="https://www.stockport.gov.uk/r-time" target="_blank" class="text-blue-500 hover:underline">Visit
						Website</a>
				</article>
		...
		<section id="events" class="relative brand-top-border p-5 bg-green text-center">
