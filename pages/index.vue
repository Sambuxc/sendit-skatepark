	...
	<main class="w-svw h-svh">
		...
		<section class="py-12 w-full h-fit flex flex-col items-start justify-center bg-blue">
			<div class="p-9 container mx-auto w-full h-full flex flex-col items-start">
				...
				<p class="mb-10">If you would like to book us please send us a direct message on our
					<a href="https://www.instagram.com/senditskatepark/tagged" target="_blank">Instagram page.
					</a>
				</p>
			</div>
		...
		<footer class="py-6 bg-green text-white text-center">
			...
			<a class="inline-block mb-6 p-5 rounded-full bg-yellow border-4 border-black box-shadow text-black no-underline"
				...
				<svg width="25px" height="25px" viewBox="0 0 60 60" version="1.1" xmlns="http://www.w3.org/2000/svg"
					xmlns:xlink="https://www.w3.org/1999/xlink">
					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
						<g transform="translate(-511.000000, -20.000000)" fill="#000000">
							<g>
