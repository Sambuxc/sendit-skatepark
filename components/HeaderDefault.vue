<template>
	...
	>
		<nav
			:class="[
				navFixed ? 'fixed left-0 top-0' : 'relative',
			]"
			class="p-4 flex justify-between gap-5 text-center w-full transition-transform duration-500 ease-in-out translate-y-0"
		>
