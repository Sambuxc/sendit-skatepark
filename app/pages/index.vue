	...
	<main class="w-svw h-svh">
		<HeaderDefault>
			<article class="relative bg-black w-full h-screen">
				<YouTubeFacade video-id="2nYtd-ewtuE" title="SEND IT Skatepark highlights video" />
			</article>
		...
		<section class="w-full h-fit flex flex-col md:flex-row items-center justify-center bg-yellow-50">
			<div class="md:flex-1 flex flex-col items-center justify-center order-last md:order-first">
				<article class="my-2 py-5 px-12 w-full flex flex-col gap-5">
					...
					<p class="text-center">
						View more on our
						<a class="text-blue" href="https://www.instagram.com/senditskatepark/tagged" target="_blank">
							Instagram.
						</a>
					</p>
				</article>
		...
		<section class="py-12 w-full h-fit flex flex-col items-start justify-center bg-blue">
			<div class="p-9 container mx-auto w-full h-full flex flex-col items-start">
				...
				<p class="mb-10">
					...
					<a href="https://www.instagram.com/senditskatepark/tagged" target="_blank">
						Instagram page.
					</a>
				</p>
			</div>
			...
			<div class="p-5 container mx-auto flex flex-col md:flex-row justify-center items-center gap-5">
				<article class="w-full md:w-1/3 flex flex-col items-center bg-white p-5 rounded-lg shadow-lg">
					<blockquote class="instagram-media" data-instgrm-captioned
						...
						<div style="padding: 16px">
							<a href="https://www.instagram.com/p/DAO4BkgtAa1/?utm_source=ig_embed&amp;utm_campaign=loading" style="
									background: #ffffff;
									line-height: 0;
									padding: 0 0;
									text-align: center;
					...
					<a href="https://www.peoplewithgrit.org/" target="_blank" class="text-blue-500 hover:underline">
						Visit Website
					</a>
				</article>
				...
				<article class="w-full md:w-1/3 flex flex-col items-center bg-white p-5 rounded-lg shadow-lg">
					...
					<a href="https://www.stockport.gov.uk/r-time" target="_blank" class="text-blue-500 hover:underline">
						Visit Website
					</a>
				</article>
		...
		<section id="find-us" class="relative brand-top-border py-12 px-5 bg-green text-center">
			...
			<p>
				...
				<img class="mx-auto box-shadow rounded-lg" width="600"
		...
		<footer class="py-6 bg-green text-white text-center">
			...
			<a class="inline-block mb-6 p-5 rounded-full bg-yellow border-4 border-black box-shadow text-black no-underline"
				href="https://www.instagram.com/senditskatepark/" target="_blank">
