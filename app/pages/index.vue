<template>
	<main class="w-svw h-svh">
		...
		<section
			id="our-events"
			class="w-full h-fit flex flex-col md:flex-row items-center justify-center bg-yellow-50"
		>
			<div
				class="md:flex-1 md:w-full h-full flex flex-col order-last md:order-first"
			>
				<img
		...
		>
			...
			>
				<article class="my-2 py-5 px-12 w-full">
					...
					<ul class="mb-5 list-disc list-inside pl-5 text-left">
						<li>Art Battle Grit Studios - September 2024</li>
						<li>Bosden Farm Youths - July 2024</li>
						<li>Aston Council x Grit Studios - May 2024.</li>
						<li>Adswood Community Centre x Autisk - August 2023</li>
						<li>Grit Studios x Stockport - September 2023.</li>
					</ul>
					...
					<p class="text-center">
						...
						<a
							class="text-blue"
							href="https://www.instagram.com/senditskatepark/tagged"
							target="_blank"
						>
							Instagram.
						</a>
			...
			<div
				class="md:flex-1 md:w-full h-full flex flex-col order-first md:order-last"
			>
				<img
					class="object-contain"
		...
		<section
			class="py-12 w-full h-fit flex flex-col items-start justify-center bg-blue"
		>
			<div
				class="p-9 container mx-auto w-full h-full flex flex-col items-start"
			>
				<h2 class="mb-9 uppercase">Partnering with...</h2>
				<p>
					We are proud to partner with these organisations to provide the best
					experiences for our community.
				</p>
				<p class="mb-10">
					If you would like to book us please send us a direct message on our
					<a
						href="https://www.instagram.com/senditskatepark/tagged"
						target="_blank"
					>
			...
			<div
				class="p-5 container mx-auto flex flex-col md:flex-row justify-center items-center gap-5"
			>
				<article
					class="w-full md:w-1/3 flex flex-col items-center bg-white p-5 rounded-lg shadow-lg"
				>
					<blockquote
						class="instagram-media"
						data-instgrm-captioned
						data-instgrm-permalink="https://www.instagram.com/p/DAO4BkgtAa1/?utm_source=ig_embed&amp;utm_campaign=loading"
					...
					>
						<div style="padding: 16px">
							<a
								href="https://www.instagram.com/p/DAO4BkgtAa1/?utm_source=ig_embed&amp;utm_campaign=loading"
								style="
									background: #ffffff;
									line-height: 0;
									padding: 0 0;
							...
							>
								<a
									...
									target="_blank"
								>
									A post shared by Fii 🤓 | Photographer 📷 (@fionafinchett)
								</a>
							</p>
						</div>
					</blockquote>

					<h3 class="mt-6">Grit Studios</h3>
					<p class="text-center">
						A creative hub for young people in Stockport.
					</p>
					<a
						href="https://www.peoplewithgrit.org/"
						target="_blank"
				...
				>
					<img
						src="../assets/images/grit_studios-and-stockport.jpg"
						alt="R-Time"
						class="mb-6 box-shadow rounded-md"
					/>
					<h3>R-Time</h3>
					<p class="text-center">
						A charity that empowers young voices in Stockport.
					</p>
					<a
						href="https://www.stockport.gov.uk/r-time"
						target="_blank"
						class="text-blue-500 hover:underline"
					>
						Visit Website
				...
				>
					<img
						src="../assets/images/aston-sendit-skatepark.jpg"
						alt="Community events with Send it Skatepark"
						class="mb-6 box-shadow rounded-md"
					/>
					<h3>Bosden Youth Centre</h3>
					<p class="text-center">
						Providing opportunities for youth to learn and grow.
					</p>
					<!-- <a href="https://www.facebook.com/events/bosden-pub-dining-car-park/bosden-youth-present-skate-n-shop/438581158990278/"
						target="_blank" class="text-blue-500 hover:underline">Visit Website</a> -->
				</article>
			</div>
		</section>
		...
		>
			...
			<p>
				...
				<img
					...
					width="600"
					src="../assets/images/portable-skate-ramps-in-stockport-borough.png"
		...
		<footer class="py-6 bg-green text-white text-center">
			<p class="mb-6">
				Follow us on Instagram for the latest updates and events.
			</p>

			<a
				class="inline-block mb-6 p-5 rounded-full bg-yellow border-4 border-black box-shadow text-black no-underline"
				href="https://www.instagram.com/senditskatepark/"
				target="_blank"
			>
				<svg
					width="25px"
