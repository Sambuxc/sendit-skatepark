<template>
	<nav
		:class="[navFixed ? 'fixed left-0 top-0' : 'relative']"
	...
	>
		...
		<div class="flex md:gap-5 items-center lg:items-start justify-center">
			<div class="flex flex-col md:flex-row items-center gap-2 md:gap-5">
				<NuxtLink
					to="mailto:senditskatepark@hotmail.com"
					class="bg-red text-black no-underline"
				>
					Book Us
				</NuxtLink>
				...
				<NuxtLink
					to="#our-events"
					class="bg-blue text-black no-underline"
				>
					Events
				</NuxtLink>
			</div>
			...
			<div class="flex flex-col md:flex-row items-center gap-2 md:gap-5">
				<NuxtLink
					to="#contact-us"
					class="bg-green text-black no-underline"
				>
					Contact
				</NuxtLink>

				<NuxtLink
					to="https://www.instagram.com/senditskatepark/"
					target="_blank"
					class="bg-yellow text-black no-underline"
				>
					<svg
						width="25px"
						height="25px"
